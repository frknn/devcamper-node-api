...
exports.login = asyncHandler(async (req, res, next) => {
  ...
  // Check if password matches with email in db
...
exports.resetPassword = asyncHandler(async (req, res, next) => {
  ...
  // Get hashed token
  const resetPwToken = crypto.createHash('sha256').update(req.params.resetToken).digest('hex');
  ...
  // Set new password, when we set a field to undefined, it goes away, won't be saved into db as fields
...
// @access  Private
exports.updateNameAndMail = asyncHandler(async (req, res, next) => {
